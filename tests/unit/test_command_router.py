...
from PROJECT.dispatch.command_router import ROUTE_OPEN_PROFILE, ROUTE_PROFILE_EDIT, ROUTE_SHOW_WEATHER, ROUTE_SHOW_WEATHER_MENU, ROUTE_UNKNOWN_INPUT, route_message
