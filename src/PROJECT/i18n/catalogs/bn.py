...
MYFIELDS_CODE_REPAIR_PROMPT = "নতুন ক্ষেতের কোড লিখুন।"
MYFIELDS_LOCATION_TO_CODE_REPAIR_PROMPT = "এই অবস্থান থেকে মিলে যাওয়া ক্ষেত পাওয়া যায়নি।\nক্ষেতের কোড লিখুন।"
...
EVIDENCE_REASON_UNSUPPORTED_FILE_TYPE = "শুধু মূল JPEG ডকুমেন্ট ফাইল জমা দেওয়া যাবে।"
EVIDENCE_REASON_ARTIFACT_READ_FAILED = "ফাইলের মেটাডেটা পড়া যায়নি। মূল JPEG ডকুমেন্ট আবার পাঠান।"
...
INPUT_RESOLVE_RAW_INPUT_REPAIR_PROMPT = "মিল পাওয়া যায়নি।\nনতুন মান লিখুন।"
INPUT_RESOLVE_CANDIDATE_NONE_MESSAGE = "মিল পাওয়া যায়নি।\n[আবার লিখুন], [পরে], বা [ম্যানুয়াল রিভিউ] বেছে নিন।"
...
GUIDED_FLOW_FERTILIZER = "সার ইনপুট"
GUIDED_FLOW_YIELD = "ফসল ইনপুট"
...
GUIDED_SUMMARY_STAGE_LABEL = "সারাংশ ধাপ"
GUIDED_RECEIVED_STAGE_LABEL = "গৃহীত"
GUIDED_OPERATOR_REPLY_STAGE_LABEL = "অপারেটর উত্তর"
GUIDED_CLOSED_STAGE_LABEL = "শেষ হয়েছে"
GUIDED_INPUT_MODE_BUTTON_ONLY = "শুধু বোতাম"
GUIDED_INPUT_MODE_TEXT_ALLOWED = "লিখে দিন"
GUIDED_INPUT_MODE_LOCATION_ATTACHMENT = "অবস্থান পাঠান"
GUIDED_INPUT_MODE_DOCUMENT_UPLOAD = "document আপলোড"
GUIDED_INPUT_MODE_STATUS_WAIT = "নির্দেশনার অপেক্ষা"
GUIDED_DRAFT_SUMMARY_PREFIX = "এখনকার তথ্য"
GUIDED_NEXT_ACTIONS_LABEL = "এরপর যা করা যাবে"
...
MYFIELDS_DRAFT_FIELD_LABEL = "জমি"
MYFIELDS_DRAFT_REQUESTED_CODE_LABEL = "লেখা ক্ষেতের কোড"
MYFIELDS_CODE_EXAMPLES = ("FIELD-001", "FIELD-105")
MYFIELDS_CODE_UNSUPPORTED_INPUT_HINT = "বর্ণনামূলক অনুরোধ, যেমন \"আমার কাছের ক্ষেতটা খুঁজে দিন\""
INPUT_RESOLVE_DRAFT_TARGET_LABEL = "লক্ষ্য"
INPUT_RESOLVE_DRAFT_METHOD_LABEL = "ইনপুট পদ্ধতি"
INPUT_RESOLVE_DRAFT_RAW_INPUT_LABEL = "মূল ইনপুট"
INPUT_RESOLVE_DRAFT_CANDIDATE_COUNT_LABEL = "প্রার্থী সংখ্যা"
EVIDENCE_LOCATION_ACCEPTED_LABEL = "অবস্থান নেওয়া হয়েছে"
EVIDENCE_FILE_NAME_LABEL = "ফাইলের নাম"
...
RECOVERY_DOCUMENT_UPLOAD_HINT = "এই ধাপে document আপলোড করতে হবে।"
RECOVERY_STATUS_WAIT_HINT = "এই ধাপে নতুন ইনপুটের চেয়ে পরের নির্দেশনার অপেক্ষা জরুরি।"
...
FERTILIZER_PRODUCT_UNSUPPORTED_INPUT_HINT = "এক বাক্যে একাধিক মান মেশানো লেখা, যেমন \"গতকাল 20kg সার ব্যবহার করেছি\""
FERTILIZER_AMOUNT_UNSUPPORTED_INPUT_HINT = "সংখ্যা বা একক ছাড়া অস্পষ্ট লেখা, যেমন \"অল্প ব্যবহার করেছি\""
FERTILIZER_DATE_UNSUPPORTED_INPUT_HINT = "শুধু সময়ের পরিসর বলা, যেমন \"গত সপ্তাহের দিকে\""
...
FERTILIZER_REPAIR_PRODUCT_MESSAGE = "নতুন পণ্যের নাম লিখুন।"
FERTILIZER_REPAIR_AMOUNT_MESSAGE = "নতুন পরিমাণ লিখুন।"
FERTILIZER_REPAIR_DATE_MESSAGE = "নতুন ব্যবহারের তারিখ লিখুন।"
FERTILIZER_DIRECT_UPDATE_MESSAGE = "পরিবর্তন রাখা হয়েছে।\nদেখে [ঠিক আছে] চাপুন।"
YIELD_READY_PROMPT = "ফসল তোলার জন্য প্রস্তুত কি?"
YIELD_FIELD_PROMPT = "যে ক্ষেত থেকে ফসল তোলা হয়েছে, সেই ক্ষেতের নাম লিখুন।"
...
YIELD_FIELD_UNSUPPORTED_INPUT_HINT = "অস্পষ্ট বর্ণনা, যেমন \"যে ক্ষেত থেকে আগে তুলেছিলাম\""
YIELD_AMOUNT_UNSUPPORTED_INPUT_HINT = "সংখ্যা ছাড়া লেখা, যেমন \"অনেক পেয়েছি\""
YIELD_DATE_UNSUPPORTED_INPUT_HINT = "বিস্তৃত সময়-ভিত্তিক লেখা, যেমন \"কয়েক দিন আগে\""
...
YIELD_EDIT_MESSAGE = "ফসল তোলার কোন অংশ বদলাবেন, বেছে নিন।"
...
YIELD_REPAIR_FIELD_MESSAGE = "নতুন ক্ষেতের নাম লিখুন।"
YIELD_REPAIR_AMOUNT_MESSAGE = "নতুন ফসলের পরিমাণ লিখুন।"
YIELD_REPAIR_DATE_MESSAGE = "নতুন ফসল তোলার তারিখ লিখুন।"
INPUT_RESOLVE_TARGET_PROMPT = "যে মান ঠিক করতে হবে, তা বেছে নিন।"
INPUT_RESOLVE_METHOD_PROMPT = "ইনপুটের ধরন বেছে নিন।\nএখন শুধু [লিখে দিন] ব্যবহার করা যাবে।"
INPUT_RESOLVE_RAW_INPUT_PROMPT = "যে মানটি ঠিক করতে চান, সেটি হুবহু লিখুন।"
INPUT_RESOLVE_RAW_INPUT_EXAMPLES = ("FIELD-001", "Plot 1")
INPUT_RESOLVE_RAW_INPUT_UNSUPPORTED_INPUT_HINT = "শুধু চাহিদা বর্ণনা করা বাক্য, যেমন \"আমার জন্য সবচেয়ে কাছেরটা বেছে নিন\""
