...
BUTTON_FIELD_LOOKUP_CODE = "고유 번호 입력"
BUTTON_INPUT_RESOLVE = "입력 해석"
BUTTON_INPUT_RESOLVE_TARGET_FIELD_CODE = "농지 고유 번호"
BUTTON_INPUT_RESOLVE_TARGET_FIELD_NAME = "농지 이름"
BUTTON_INPUT_RESOLVE_METHOD_TYPED_TEXT = "글로 입력"
BUTTON_INPUT_RESOLVE_CONFIRM_CANDIDATE = "이 후보로 확정"
BUTTON_INPUT_RESOLVE_RETRY = "다시 입력"
BUTTON_INPUT_RESOLVE_RETRY_LATER = "나중에 다시"
BUTTON_INPUT_RESOLVE_MANUAL_REVIEW = "운영 검토"
...
MYFIELDS_EMPTY_MESSAGE = "등록된 농지가 없습니다.\n농지 등록을 시작해 주세요."
MYFIELDS_SUMMARY_MESSAGE = "현재 등록된 농지입니다."
MYFIELDS_SUMMARY_GUIDANCE = "농지를 더 등록하거나 목록을 새로고침할 수 있습니다."
MYFIELDS_METHOD_PROMPT = "농지 등록 방법을 선택하세요.\n위치 공유 또는 고유 번호 입력으로 진행할 수 있습니다."
MYFIELDS_LOCATION_PROMPT = "Telegram의 위치 첨부 기능으로 현재 위치를 보내주세요.\n메시지 입력창의 첨부 메뉴에서 위치를 선택하면 됩니다."
MYFIELDS_CODE_PROMPT = "농지 고유 번호를 입력하세요."
MYFIELDS_CODE_REPAIR_PROMPT = "새 고유 번호를 입력하세요."
MYFIELDS_LOCATION_TO_CODE_REPAIR_PROMPT = "이 위치에서는 후보를 찾지 못했습니다.\n고유 번호를 입력하세요."
MYFIELDS_NO_REGISTRY_MESSAGE = "현재 공개된 농지 레지스트리가 없습니다.\n잠시 뒤 다시 시도하거나 지원을 요청하세요."
MYFIELDS_LOCATION_NO_CANDIDATE_MESSAGE = "이 위치에서는 등록 가능한 농지 후보를 찾지 못했습니다.\n고유 번호를 입력하거나 다시 시도해 주세요."
MYFIELDS_CODE_NOT_FOUND_MESSAGE = "입력한 고유 번호를 찾지 못했습니다.\n다시 입력하거나 위치로 찾기를 선택해 주세요."
MYFIELDS_CANDIDATE_PROMPT = "관련 농지 후보를 찾았습니다.\n아래에서 맞는 농지를 선택하세요."
MYFIELDS_CONFIRM_MESSAGE = "농지 바인딩 내용을 확인하세요."
MYFIELDS_CONFIRM_GUIDANCE = "맞으면 [확인]을 누르세요."
MYFIELDS_BINDING_CONFIRMED_MESSAGE = "농지가 등록되었습니다."
...
EVIDENCE_ACCEPTED_MESSAGE = "증빙 제출이 완료되었습니다.\n기본 검증을 통과했습니다."
EVIDENCE_RETRY_REQUIRED_MESSAGE = "증빙을 다시 제출해 주세요."
EVIDENCE_MANUAL_REVIEW_MESSAGE = "증빙 제출을 운영 검토로 넘겼습니다."
EVIDENCE_REASON_MISSING_EXIF = "EXIF 정보가 없습니다."
EVIDENCE_REASON_MISSING_GPS = "GPS 정보가 없습니다."
EVIDENCE_REASON_MISSING_CAPTURE_TIME = "촬영 시각 정보가 없습니다."
EVIDENCE_REASON_LOCATION_DISTANCE_TOO_FAR = "현재 위치와 사진 좌표 차이가 큽니다."
EVIDENCE_REASON_UNSUPPORTED_FILE_TYPE = "JPEG 원본 문서 파일만 제출할 수 있습니다."
EVIDENCE_REASON_ARTIFACT_READ_FAILED = "파일 메타데이터를 읽지 못했습니다. 원본 JPEG 문서를 다시 보내주세요."
...
INPUT_RESOLVE_RAW_INPUT_FALLBACK = "정할 원문을 다시 입력해 주세요.\n예: FIELD-001, 논 1"
INPUT_RESOLVE_RAW_INPUT_REPAIR_PROMPT = "맞는 후보를 찾지 못했습니다.\n새 값을 입력하세요."
INPUT_RESOLVE_CANDIDATE_NONE_MESSAGE = "맞는 후보를 찾지 못했습니다.\n[다시 입력], [나중에 다시], [운영 검토] 중에서 선택하세요."
INPUT_RESOLVE_MANUAL_REVIEW_MESSAGE = "입력 해석 요청을 운영 검토로 넘겼습니다.\n후속 안내는 이 대화창에서 이어집니다."
INPUT_RESOLVE_INVALID_RESUME_MESSAGE = "다시 열기 정보를 확인하지 못했습니다.\n/resolve 로 새로 시작하거나 지원을 요청하세요."
INPUT_RESOLVE_STEP_TARGET_LABEL = "정할 값 선택"
INPUT_RESOLVE_STEP_METHOD_LABEL = "입력 방식 선택"
INPUT_RESOLVE_STEP_RAW_INPUT_LABEL = "원문 입력"
INPUT_RESOLVE_STEP_CANDIDATES_LABEL = "후보 확인"
INPUT_RESOLVE_STEP_DECISION_LABEL = "후보 확정"
...
GUIDED_FLOW_FERTILIZER = "비료 입력"
GUIDED_FLOW_YIELD = "수확량 입력"
...
GUIDED_SUMMARY_STAGE_LABEL = "요약 단계"
GUIDED_RECEIVED_STAGE_LABEL = "접수 완료"
GUIDED_OPERATOR_REPLY_STAGE_LABEL = "운영자 답변"
GUIDED_CLOSED_STAGE_LABEL = "종료됨"
GUIDED_INPUT_MODE_BUTTON_ONLY = "버튼 선택"
GUIDED_INPUT_MODE_TEXT_ALLOWED = "텍스트 입력"
GUIDED_INPUT_MODE_LOCATION_ATTACHMENT = "위치 첨부"
GUIDED_INPUT_MODE_DOCUMENT_UPLOAD = "document 업로드"
GUIDED_INPUT_MODE_STATUS_WAIT = "안내 대기"
GUIDED_DRAFT_SUMMARY_PREFIX = "현재 입력"
GUIDED_NEXT_ACTIONS_LABEL = "다음에 할 수 있는 작업"
...
MYFIELDS_DRAFT_FIELD_LABEL = "농지"
MYFIELDS_DRAFT_REQUESTED_CODE_LABEL = "입력한 고유 번호"
MYFIELDS_CODE_EXAMPLES = ("FIELD-001", "FIELD-105")
MYFIELDS_CODE_UNSUPPORTED_INPUT_HINT = "\"근처 농지 찾아줘\"처럼 설명형 요청"
INPUT_RESOLVE_DRAFT_TARGET_LABEL = "대상"
INPUT_RESOLVE_DRAFT_METHOD_LABEL = "입력 방식"
INPUT_RESOLVE_DRAFT_RAW_INPUT_LABEL = "원문"
INPUT_RESOLVE_DRAFT_CANDIDATE_COUNT_LABEL = "후보 수"
EVIDENCE_LOCATION_ACCEPTED_LABEL = "위치 확인 완료"
EVIDENCE_FILE_NAME_LABEL = "파일명"
...
RECOVERY_CURRENT_STEP_LABEL = "현재 단계"
RECOVERY_QUICK_ACTIONS_LABEL = "바로 선택"
RECOVERY_BUTTON_ONLY_HINT = "이 단계에서는 아래 버튼으로만 선택할 수 있어요."
RECOVERY_TEXT_ALLOWED_HINT = "이 단계에서는 텍스트로 입력할 수 있어요."
RECOVERY_LOCATION_ATTACHMENT_HINT = "이 단계에서는 현재 위치를 첨부해야 해요."
RECOVERY_DOCUMENT_UPLOAD_HINT = "이 단계에서는 document 업로드가 필요해요."
RECOVERY_STATUS_WAIT_HINT = "이 단계에서는 새 입력보다 안내를 기다리는 상태예요."
...
FERTILIZER_PRODUCT_EXAMPLES = ("한아름 복합비료", "액상비료 A")
FERTILIZER_AMOUNT_EXAMPLES = ("20kg", "한 포")
FERTILIZER_DATE_EXAMPLES = ("2026-04-21", "오늘")
FERTILIZER_PRODUCT_UNSUPPORTED_INPUT_HINT = "\"복합비료 20kg을 어제 썼어요\"처럼 여러 값을 한 번에 보내는 문장"
FERTILIZER_AMOUNT_UNSUPPORTED_INPUT_HINT = "\"조금 넣었어요\"처럼 수치나 단위가 없는 표현"
FERTILIZER_DATE_UNSUPPORTED_INPUT_HINT = "\"지난주쯤\"처럼 범위만 있는 표현"
...
FERTILIZER_REPAIR_PRODUCT_MESSAGE = "새 제품명을 입력하세요."
FERTILIZER_REPAIR_AMOUNT_MESSAGE = "새 사용량을 입력하세요."
FERTILIZER_REPAIR_DATE_MESSAGE = "새 사용일을 입력하세요."
FERTILIZER_DIRECT_UPDATE_MESSAGE = "변경 내용이 반영되었습니다. 확인 후 [확인]을 누르세요."
YIELD_READY_PROMPT = "수확 준비가 되었나요?"
YIELD_FIELD_PROMPT = "수확한 농지 이름을 입력하세요."
YIELD_AMOUNT_PROMPT = "수확량을 입력하세요."
YIELD_DATE_PROMPT = "수확일을 입력하세요."
YIELD_FIELD_EXAMPLES = ("논 1", "FIELD-001")
YIELD_AMOUNT_EXAMPLES = ("320kg", "1.2t")
YIELD_DATE_EXAMPLES = ("2026-04-21", "오늘")
YIELD_FIELD_UNSUPPORTED_INPUT_HINT = "\"저번에 수확한 논\"처럼 기준이 모호한 설명"
YIELD_AMOUNT_UNSUPPORTED_INPUT_HINT = "\"많이 수확했어요\"처럼 수치가 없는 표현"
YIELD_DATE_UNSUPPORTED_INPUT_HINT = "\"며칠 전\"처럼 날짜가 넓게만 표현된 문장"
...
YIELD_EDIT_MESSAGE = "수정할 수확 항목을 선택하세요."
YIELD_EDIT_SELECT_FALLBACK = "수정할 항목을 선택하세요. [수정 시작], 뒤로가기, 처음부터 중 하나를 누를 수 있습니다."
YIELD_CONFIRMED_MESSAGE = "수확량 입력이 저장되었습니다.\n현재 세션에 보관됩니다."
YIELD_REPAIR_FIELD_MESSAGE = "새 농지 이름을 입력하세요."
YIELD_REPAIR_AMOUNT_MESSAGE = "새 수확량을 입력하세요."
YIELD_REPAIR_DATE_MESSAGE = "새 수확일을 입력하세요."
INPUT_RESOLVE_TARGET_PROMPT = "정할 값을 선택하세요."
INPUT_RESOLVE_METHOD_PROMPT = "입력 방식을 선택하세요.\n현재는 [글로 입력]만 사용할 수 있습니다."
INPUT_RESOLVE_RAW_INPUT_PROMPT = "정할 값을 그대로 입력하세요."
INPUT_RESOLVE_RAW_INPUT_EXAMPLES = ("FIELD-001", "논 1")
INPUT_RESOLVE_RAW_INPUT_UNSUPPORTED_INPUT_HINT = "\"알아서 가장 비슷한 걸 골라줘\"처럼 값 대신 설명만 보내는 문장"
...
def format_input_resolve_candidate_list(
    *,
    target_label: str,
    raw_input: str,
    ...
    return (
        f"{target_label} 후보를 찾았습니다.\n"
        f"- 원문: {raw_input}\n\n"
        f"{candidate_lines}\n\n"
        "맞는 항목을 선택하거나 다시 입력하세요."
    )


def format_input_resolve_selected_candidate(*, target_label: str, candidate_label: str) -> str:
    return (
        f"{target_label} 후보를 확인하세요.\n"
        f"- 선택 후보: {candidate_label}\n\n"
        "[이 후보로 확정], [다시 입력], [나중에 다시], [운영 검토] 중 하나를 선택하세요."
    )
...
def format_input_resolve_resolved(*, target_label: str, candidate_label: str) -> str:
    return (
        "입력 해석을 저장했습니다.\n"
        f"- 항목: {target_label}\n"
        f"- 확정 값: {candidate_label}"
    )


def format_input_resolve_reminder(*, command_text: str) -> str:
    return (
        "입력 해석을 다시 이어갈 시간이 되었습니다.\n"
        f"같은 흐름을 다시 열려면 {command_text} 를 입력하세요."
    )
...
def format_input_resolve_reminder_created(*, command_text: str) -> str:
    return (
        "나중에 다시 이어가도록 저장했습니다.\n"
        f"다시 시작할 때는 {command_text} 를 입력하세요."
    )
