...
SUPPORT_ESCALATION_MESSAGE = "지원 안내 경로입니다.\n현재는 support.escalate가 실시간 채팅으로 연결되어 있지 않아요.\n필요하면 /help, /menu, /start 로 안전하게 다시 이동할 수 있습니다."
...
YIELD_EDIT_MESSAGE = "수확량 입력을 수정할게요.\n[수정 시작]을 누르면 수확량 입력을 다시 진행합니다."
YIELD_EDIT_SELECT_FALLBACK = "[수정 시작]을 누르거나 뒤로가기, 취소, 처음부터 중 하나를 선택해주세요."
