...
MYFIELDS_CODE_REPAIR_PROMPT = "Enter the new field code."
MYFIELDS_LOCATION_TO_CODE_REPAIR_PROMPT = "No matching field was found from this location.\nEnter the field code."
...
EVIDENCE_REASON_UNSUPPORTED_FILE_TYPE = "Only original JPEG document files are supported."
EVIDENCE_REASON_ARTIFACT_READ_FAILED = "The file metadata could not be read. Please send the original JPEG document again."
...
INPUT_RESOLVE_RAW_INPUT_REPAIR_PROMPT = "No matching candidate was found.\nEnter the new value."
INPUT_RESOLVE_CANDIDATE_NONE_MESSAGE = "No matching candidate was found.\nChoose [Try again], [Later], or [Manual review]."
...
GUIDED_FLOW_FERTILIZER = "Fertilizer input"
GUIDED_FLOW_YIELD = "Yield input"
...
GUIDED_SUMMARY_STAGE_LABEL = "Summary step"
GUIDED_RECEIVED_STAGE_LABEL = "Received"
GUIDED_OPERATOR_REPLY_STAGE_LABEL = "Operator reply"
GUIDED_CLOSED_STAGE_LABEL = "Closed"
GUIDED_INPUT_MODE_BUTTON_ONLY = "Button only"
GUIDED_INPUT_MODE_TEXT_ALLOWED = "Text input"
GUIDED_INPUT_MODE_LOCATION_ATTACHMENT = "Location attachment"
GUIDED_INPUT_MODE_DOCUMENT_UPLOAD = "Document upload"
GUIDED_INPUT_MODE_STATUS_WAIT = "Waiting"
GUIDED_DRAFT_SUMMARY_PREFIX = "Current draft"
GUIDED_NEXT_ACTIONS_LABEL = "Next actions"
...
MYFIELDS_DRAFT_FIELD_LABEL = "Field"
MYFIELDS_DRAFT_REQUESTED_CODE_LABEL = "Entered field code"
MYFIELDS_CODE_EXAMPLES = ("FIELD-001", "FIELD-105")
MYFIELDS_CODE_UNSUPPORTED_INPUT_HINT = "Requests like \"find a nearby field for me\""
INPUT_RESOLVE_DRAFT_TARGET_LABEL = "Target"
INPUT_RESOLVE_DRAFT_METHOD_LABEL = "Input method"
INPUT_RESOLVE_DRAFT_RAW_INPUT_LABEL = "Raw input"
INPUT_RESOLVE_DRAFT_CANDIDATE_COUNT_LABEL = "Candidates"
EVIDENCE_LOCATION_ACCEPTED_LABEL = "Location accepted"
EVIDENCE_FILE_NAME_LABEL = "File name"
...
RECOVERY_CURRENT_STEP_LABEL = "Current step"
RECOVERY_QUICK_ACTIONS_LABEL = "Quick actions"
RECOVERY_BUTTON_ONLY_HINT = "This step uses the buttons below."
RECOVERY_TEXT_ALLOWED_HINT = "This step accepts text input."
RECOVERY_LOCATION_ATTACHMENT_HINT = "This step needs your current location attachment."
RECOVERY_DOCUMENT_UPLOAD_HINT = "This step needs a document upload."
RECOVERY_STATUS_WAIT_HINT = "This step is waiting for the next guidance."
...
FERTILIZER_PRODUCT_UNSUPPORTED_INPUT_HINT = "A sentence that mixes several values, such as \"I used compound fertilizer 20kg yesterday\""
FERTILIZER_AMOUNT_UNSUPPORTED_INPUT_HINT = "Vague phrases without a number or unit, such as \"I used a little\""
FERTILIZER_DATE_UNSUPPORTED_INPUT_HINT = "Range-only phrases, such as \"sometime last week\""
...
FERTILIZER_REPAIR_PRODUCT_MESSAGE = "Enter the new product name."
FERTILIZER_REPAIR_AMOUNT_MESSAGE = "Enter the new amount."
FERTILIZER_REPAIR_DATE_MESSAGE = "Enter the new applied date."
FERTILIZER_DIRECT_UPDATE_MESSAGE = "The change was applied.\nReview it and press [Confirm]."
YIELD_READY_PROMPT = "Is the harvest ready?"
YIELD_FIELD_PROMPT = "Enter the harvested field name."
...
YIELD_FIELD_UNSUPPORTED_INPUT_HINT = "Ambiguous descriptions such as \"the field I harvested before\""
YIELD_AMOUNT_UNSUPPORTED_INPUT_HINT = "Phrases without a number, such as \"I harvested a lot\""
YIELD_DATE_UNSUPPORTED_INPUT_HINT = "Broad phrases such as \"a few days ago\""
...
YIELD_EDIT_MESSAGE = "Choose which harvest field to edit."
...
YIELD_REPAIR_FIELD_MESSAGE = "Enter the new field name."
YIELD_REPAIR_AMOUNT_MESSAGE = "Enter the new harvest amount."
YIELD_REPAIR_DATE_MESSAGE = "Enter the new harvest date."
INPUT_RESOLVE_TARGET_PROMPT = "Choose the value to resolve."
INPUT_RESOLVE_METHOD_PROMPT = "Choose how to enter it.\nOnly [Type text] is available right now."
INPUT_RESOLVE_RAW_INPUT_PROMPT = "Type the exact value to resolve."
INPUT_RESOLVE_RAW_INPUT_EXAMPLES = ("FIELD-001", "Plot 1")
INPUT_RESOLVE_RAW_INPUT_UNSUPPORTED_INPUT_HINT = "Sentences that only describe what you want, such as \"pick the closest one for me\""
