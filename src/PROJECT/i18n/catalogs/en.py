...
YIELD_EDIT_MESSAGE = "Let's edit the yield entry.\nPress [Start edit] to enter the yield flow again."
YIELD_EDIT_SELECT_FALLBACK = "Press [Start edit], or choose Back, Cancel, or Start over."
